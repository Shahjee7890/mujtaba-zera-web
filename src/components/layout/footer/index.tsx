...
const Footer = () => {
  ...
  return (
    <footer className="w-full flex flex-col justify-center items-center pt-32 sm:pt-16 lg:pt-20 xl:pt-10">
      {/* child */}
      <div className="max-w-section w-[85%] gap-5 flex flex-col">
        <div className="flex flex-col sm:flex-row items-center sm:items-center justify-center sm:justify-between gap-8 sm:py-4">
          {/* footer menu option  */}
          <div className="inter">
              ...
              {footerMenuOptions?.map((option) => (
                <a href={option.link} key={option.id}>
                  <li className="cursor-pointer">
                    <Typography
                      size="md"
                      className="text-slate-light hover:text-secondary-dark"
                    >
                      {option?.label}
                    </Typography>
                  </li>
        ...
        <div className="flex gap-4 sm:gap-0 flex-col-reverse sm:flex-row items-center justify-between py-4 bg-white w-full">
          {/* copyright */}
          <div>
            <Typography
              size="md"
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-4 inter">
              <NavLink to={"/terms-and-conditions"}>
                <Typography size="md" className="text-slate-light">
                  Terms of Service
                </Typography>
              </NavLink>
