  ...
  return (
    <section className="bg-[url('/assets/images/shape.webp')] bg-cover bg-center h-[170px] sm:h-[190px] md:h-[210px] xl:h-[250px] w-full pb-4 pt-10 sm:pt-10 md:pt-15 lg:pt-25">
      <div className="max-w-section px-5 xl:px-0">
        <div className="rounded-[14px] bg-white shadow-[0_0_30px_rgba(0,0,0,0.2)] max-w-content flex justify center flex-col lg:flex-row items-center sm:items-center sm:justify-between gap-3 sm:gap-6 md:gap-4 px-6 sm:px-1 lg:px-10 py-5 md:py-7 lg:py-12">
          <div>
            <Typography
              size="h2"
              as="h2"
