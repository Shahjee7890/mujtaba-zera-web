...
const FormZera: FC<FormProps> = ({
  ...
  return (
    <div className="max-w-section px-5">
      {/* content */}
      <div className="max-w-content w-full bg-gradient-primary flex flex-col lg:flex-row justify-between items-center lg:items-start gap-7 lg:gap-4 xl:gap-10 rounded-[26px] px-5 pt-2 pb-5 sm:p-9 lg:px-12 lg:py-14">
        <div className="w-full flex flex-row md:flex-col items-start justify-start flex-wrap gap-5 pt-3.5">
          <Typography
            size="h2"
            as="h2"
            className="text-white leading-9 md:leading-12 text-wrap "
          >
            {title}
          </Typography>
        ...
        {/* form */}
        <div className="w-full flex flex-row lg:flex-col items-start justify-start flex-wrap bg-white rounded-[16px] px-5 lg:px-10 pt-8 lg:pt-15 pb-6 lg:pb-10">
          <form
            onSubmit={
              isContactUs
                ? formik?.handleSubmit
                : formikRemoveAccount?.handleSubmit
            }
            autoComplete="off"
            className="w-full xl:w-[530px]"
          >
            {isContactUs ? (
              ...
              <div className="flex flex-col gap-6 w-full">
                <InputField
                  ...
                  error={
                    formikRemoveAccount?.touched.email &&
                ...
                <InputPassword
                  ...
                  onBlur={formikRemoveAccount?.handleBlur}
                  error={
                    formikRemoveAccount?.touched.password &&
                ...
                <TextField
                  ...
                  error={
                    formikRemoveAccount?.touched.message &&
